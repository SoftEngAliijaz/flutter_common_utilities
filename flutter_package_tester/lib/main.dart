        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: ResponsiveUtil(
              mobile: _buildVerticalStepper(context),
              tablet: _buildHorizontalStepper(context),
              desktop: _buildHorizontalStepper(context),
            ),
          ),
        ),
      ),
          ...
          child: Row(
            ...
            children: List.generate(_totalSteps * 2 - 1, (index) {
              if (index % 2 == 0) {
                ...
                return _buildStepConnector(index);
              }
            }),
          ),
        ),
          ...
          child: Column(
            children: List.generate(_totalSteps * 2 - 1, (index) {
              if (index % 2 == 0) {
                ...
                return _buildVerticalConnector(index);
              }
            }),
          ),
        ),
